...
export function remainingMinutesInOven(actualMinutesInOven) {
  ...
  let rest_lasagne = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven
  return rest_lasagne
...
export function preparationTimeInMinutes(numberOfLayers) {
  ...
  let couche_number = numberOfLayers * 2
  return couche_number
  //throw new Error('Remove this line and implement the function');
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  let newlayers = numberOfLayers * 2
  let newoven = actualMinutesInOven
  return newlayers + newoven
console.log('Debug message');  //throw new Error('Remove this line and implement the function');
}
